...
NS_LOG_COMPONENT_DEFINE ("ImplicitConflictScenario");
...
// NEW: t-Reordering Timer for xAPP3 (Robust Link Adaptation)
...
main(int argc, char *argv[]) {
  ...
  // Configure t-Reordering Timer (xAPP3 parameter)
  ...
  NS_LOG_UNCOND("Implicit Conflict Scenario Parameters:");
  NS_LOG_UNCOND("  TxPower: " << txPower << " dBm");
  NS_LOG_UNCOND("  Tilt: " << tilt << " degrees");
  NS_LOG_UNCOND("  t-Reordering: " << tReorderingMs << " ms");
